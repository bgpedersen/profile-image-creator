...
import { SharedDialogDefaultComponent } from 'src/app/shared/components/shared-dialog-default/shared-dialog-default.component';

import { DownloadUrl } from '../../models/DownloadUrls.model';
import { ImageEditorService } from '../../services/image-editor.service';
import { BottomSheetDownloadurlsComponent } from '../bottom-sheet-downloadurls/bottom-sheet-downloadurls.component';
...
export class EditImageComponent implements AfterViewInit {
  ...
  onDelete() {
    ...
    dialogRef
      ...
      .pipe(first())
      .subscribe((result) =>
        result ? this.imageEditorService.resetDataUrl() : null
      );
  }
